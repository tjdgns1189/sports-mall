    ...
    <table id="addressTable">
        <tbody>
            ...
            <tr>
                ...
                <td>
                <select id="addressOpinion" style="width: 300px;" onchange="showInputField()">
        			<option value="option1">배송 시 요청사항을 선택하세요</option>
        			<option value="option2">부재 시 경비실에 맡겨주세요</option>
        			<option value="option3">문 앞에 놓아주세요</option>
        			<option value="option4">부재 시 전화주세요</option>
        			<option value="option5">배송 시 벨 눌러주세요</option>
    			</select>
                </td>
            </tr>
        </tbody>
