<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			...
			<body>
				<h1><a href="${pageContext.request.contextPath}/index">QNA 게시판입니다</a></h1>
					...
					<tbody>
						<c:forEach var="vo" items="${list }">
							<tr>
								<td>${vo.qnaBoardId }</td>
								<td>${vo.memberId }</td>
								<td><a href="qnaDetail?qnaBoardId=${vo.qnaBoardId }&page=${pageMaker.criteria.page}">${vo.qnaBoardTitle
										}</a></td>
								<fmt:formatDate value="${vo.qnaBoardCreatedDate }" pattern="yyyy-MM-dd HH:mm:ss"
									var="qnaBoardCreatedDate" />
