...
public class NoticeController {
	...
	public String noticeRegisterPOST(@RequestParam String noticeTitle, @RequestParam String noticeContent) {
	...
	@PostMapping("/update")
	public String noticeUpdate(@RequestParam String noticeTitle, @RequestParam String noticeContent,
